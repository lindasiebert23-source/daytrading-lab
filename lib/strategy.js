...
/**
 * COMPARISON STRATEGY - "Trend Cross Only"
 * No RSI timing: enter LONG the moment EMA50 crosses above EMA200, same
 * stop/target/cost mechanics as the baseline. Isolates whether the RSI
 * timing adds anything beyond just being long during uptrends.
 */
...
module.exports = { PARAMS, generateSignals, generateTrendCrossSignals };
