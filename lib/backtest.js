...
function walkForwardBacktest(candles, opts, costs, strategyParams) {
  ...
  const inSampleResult = simulate(inSample, opts, costs, strategyParams);
  const outOfSampleResult = simulate(outOfSample, opts, costs, strategyParams);
